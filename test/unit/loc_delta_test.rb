...
class LocDeltaTest < Ohcount::Test
	...
	def test_loc_delta_initializer
		delta = LocDelta.new(:language => "c", :code_added => 1, :code_removed => 10,
	...
	def test_addition
		delta = LocDelta.new(:language => "c", :code_added => 1, :code_removed => 10,
											 :comments_added => 2, :comments_removed => 20, :blanks_added => 3, :blanks_removed => 30)
		delta += LocDelta.new(:language => "c", :code_added => 100, :code_removed => 1000,
	...
	def test_addition_requires_matching_language
		delta = LocDelta.new(:language => "c")
		assert_raises(ArgumentError) do
			delta += LocDelta.new(:language => "java")
		end
	end
end
