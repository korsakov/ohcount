...
module Ohcount
	...
	class CMonoglot < Monoglot
		...
		# * +no_escape_squote+ - Similar for single quotes.  Note that '' exits and enters a singly quoted string,
		#   so languages that use '' to produce ' fall through and work well enough.
		#
